...
# from base.settings import COOKIES_CACHE_FILE
#
#
# requests.packages.urllib3.disable_warnings()
#
#
# class NetHelper(metaclass=Singleton):
#     name = "net_helper"
#
#     def __init__(self, logger=None, *args, **kwargs):
#         self.log = logger
#         # TODO: login and save session
...
#     #         d = pickle.load(f)
#     #         sess.cookies.update(d)
#     #         print("读取持久化cookies")
#     #     sess.headers.update(headers)
#     #     resp = sess.get(self.USER_URL.format(domain=self.domain))
